...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ir,depthTest:!1,depthWrite:!1})}function gm(){return new Br({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zd(),fragmentShader:`
		...
		`,blending:ir,depthTest:!1,depthWrite:!1})}function _m(){return new Br({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zd(),fragmentShader:`
