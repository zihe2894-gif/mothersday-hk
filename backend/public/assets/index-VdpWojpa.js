 ...
 */var ta=Symbol.for("react.element"),c0=Symbol.for("react.portal"),f0=Symbol.for("react.fragment"),d0=Symbol.for("react.strict_mode"),h0=Symbol.for("react.profiler"),p0=Symbol.for("react.provider"),m0=Symbol.for("react.context"),g0=Symbol.for("react.forward_ref"),_0=Symbol.for("react.suspense"),v0=Symbol.for("react.memo"),x0=Symbol.for("react.lazy"),th=Symbol.iterator;function y0(n){return n===null||typeof n!="object"?null:(n=th&&n[th]||n["@@iterator"],typeof n=="function"?n:null)}var sg={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},og=Object.assign,ag={};function js(n,e,t){this.props=n,this.context=e,this.refs=ag,this.updater=t||sg}js.prototype.isReactComponent={};js.prototype.setState=function(n,e){if(typeof n!="object"&&typeof n!="function"&&n!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,n,e,"setState")};js.prototype.forceUpdate=function(n){this.updater.enqueueForceUpdate(this,n,"forceUpdate")};function lg(){}lg.prototype=js.prototype;function kf(n,e,t){this.props=n,this.context=e,this.refs=ag,this.updater=t||sg}var Bf=kf.prototype=new lg;Bf.constructor=kf;og(Bf,js.prototype);Bf.isPureReactComponent=!0;var nh=Array.isArray,ug=Object.prototype.hasOwnProperty,zf={current:null},cg={key:!0,ref:!0,__self:!0,__source:!0};function fg(n,e,t){var i,r={},s=null,o=null;if(e!=null)for(i in e.ref!==void 0&&(o=e.ref),e.key!==void 0&&(s=""+e.key),e)ug.call(e,i)&&!cg.hasOwnProperty(i)&&(r[i]=e[i]);var a=arguments.length-2;if(a===1)r.children=t;else if(1<a){for(var l=Array(a),u=0;u<a;u++)l[u]=arguments[u+2];r.children=l}if(n&&n.defaultProps)for(i in a=n.defaultProps,a)r[i]===void 0&&(r[i]=a[i]);return{$$typeof:ta,type:n,key:s,ref:o,props:r,_owner:zf.current}}function S0(n,e){return{$$typeof:ta,type:n.type,key:e,ref:n.ref,props:n.props,_owner:n._owner}}function Hf(n){return typeof n=="object"&&n!==null&&n.$$typeof===ta}function M0(n){var e={"=":"=0",":":"=2"};return"$"+n.replace(/[=:]/g,function(t){return e[t]})}var ih=/\/+/g;function xu(n,e){return typeof n=="object"&&n!==null&&n.key!=null?M0(""+n.key):e.toString(36)}function nl(n,e,t,i,r){var s=typeof n;(s==="undefined"||s==="boolean")&&(n=null);var o=!1;if(n===null)o=!0;else switch(s){case"string":case"number":o=!0;break;case"object":switch(n.$$typeof){case ta:case c0:o=!0}}if(o)return o=n,r=r(o),n=i===""?"."+xu(o,0):i,nh(r)?(t="",n!=null&&(t=n.replace(ih,"$&/")+"/"),nl(r,e,t,"",function(u){return u})):r!=null&&(Hf(r)&&(r=S0(r,t+(!r.key||o&&o.key===r.key?"":(""+r.key).replace(ih,"$&/")+"/")+n)),e.push(r)),1;if(o=0,i=i===""?".":i+":",nh(n))for(var a=0;a<n.length;a++){s=n[a];var l=i+xu(s,a);o+=nl(s,e,t,l,r)}else if(l=y0(n),typeof l=="function")for(n=l.call(n),a=0;!(s=n.next()).done;)s=s.value,l=i+xu(s,a++),o+=nl(s,e,t,l,r);else if(s==="object")throw e=String(n),Error("Objects are not valid as a React child (found: "+(e==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":e)+"). If you meant to render a collection of children, use an array instead.");return o}function fa(n,e,t){if(n==null)return n;var i=[],r=0;return nl(n,i,"","",function(s){return e.call(t,s,r++)}),i}function E0(n){if(n._status===-1){var e=n._result;e=e(),e.then(function(t){(n._status===0||n._status===-1)&&(n._status=1,n._result=t)},function(t){(n._status===0||n._status===-1)&&(n._status=2,n._result=t)}),n._status===-1&&(n._status=0,n._result=e)}if(n._status===1)return n._result.default;throw n._result}var on={current:null},il={transition:null},T0={ReactCurrentDispatcher:on,ReactCurrentBatchConfig:il,ReactCurrentOwner:zf};function dg(){throw Error("act(...) is not supported in production builds of React.")}We.Children={map:fa,forEach:function(n,e,t){fa(n,function(){e.apply(this,arguments)},t)},count:function(n){var e=0;return fa(n,function(){e++}),e},toArray:function(n){return fa(n,function(e){return e})||[]},only:function(n){if(!Hf(n))throw Error("React.Children.only expected to receive a single React element child.");return n}};We.Component=js;We.Fragment=f0;We.Profiler=h0;We.PureComponent=kf;We.StrictMode=d0;We.Suspense=_0;We.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=T0;We.act=dg;We.cloneElement=function(n,e,t){if(n==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+n+".");var i=og({},n.props),r=n.key,s=n.ref,o=n._owner;if(e!=null){if(e.ref!==void 0&&(s=e.ref,o=zf.current),e.key!==void 0&&(r=""+e.key),n.type&&n.type.defaultProps)var a=n.type.defaultProps;for(l in e)ug.call(e,l)&&!cg.hasOwnProperty(l)&&(i[l]=e[l]===void 0&&a!==void 0?a[l]:e[l])}var l=arguments.length-2;if(l===1)i.children=t;else if(1<l){a=Array(l);for(var u=0;u<l;u++)a[u]=arguments[u+2];i.children=a}return{$$typeof:ta,type:n.type,key:r,ref:s,props:i,_owner:o}};We.createContext=function(n){return n={$$typeof:m0,_currentValue:n,_currentValue2:n,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},n.Provider={$$typeof:p0,_context:n},n.Consumer=n};We.createElement=fg;We.createFactory=function(n){var e=fg.bind(null,n);return e.type=n,e};We.createRef=function(){return{current:null}};We.forwardRef=function(n){return{$$typeof:g0,render:n}};We.isValidElement=Hf;We.lazy=function(n){return{$$typeof:x0,_payload:{_status:-1,_result:n},_init:E0}};We.memo=function(n,e){return{$$typeof:v0,type:n,compare:e===void 0?null:e}};We.startTransition=function(n){var e=il.transition;il.transition={};try{n()}finally{il.transition=e}};We.unstable_act=dg;We.useCallback=function(n,e){return on.current.useCallback(n,e)};We.useContext=function(n){return on.current.useContext(n)};We.useDebugValue=function(){};We.useDeferredValue=function(n){return on.current.useDeferredValue(n)};We.useEffect=function(n,e){return on.current.useEffect(n,e)};We.useId=function(){return on.current.useId()};We.useImperativeHandle=function(n,e,t){return on.current.useImperativeHandle(n,e,t)};We.useInsertionEffect=function(n,e){return on.current.useInsertionEffect(n,e)};We.useLayoutEffect=function(n,e){return on.current.useLayoutEffect(n,e)};We.useMemo=function(n,e){return on.current.useMemo(n,e)};We.useReducer=function(n,e,t){return on.current.useReducer(n,e,t)};We.useRef=function(n){return on.current.useRef(n)};We.useState=function(n){return on.current.useState(n)};We.useSyncExternalStore=function(n,e,t){return on.current.useSyncExternalStore(n,e,t)};We.useTransition=function(){return on.current.useTransition()};We.version="18.3.1";rg.exports=We;var Jt=rg.exports;const w0=u0(Jt);/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(N,F){var H=N.length;N.push(F);e:for(;0<H;){var Y=H-1>>>1,$=N[Y];if(0<r($,F))N[Y]=F,N[H]=$,H=Y;else break e}}function t(N){return N.length===0?null:N[0]}function i(N){if(N.length===0)return null;var F=N[0],H=N.pop();if(H!==F){N[0]=H;e:for(var Y=0,$=N.length,X=$>>>1;Y<X;){var K=2*(Y+1)-1,ae=N[K],fe=K+1,pe=N[fe];if(0>r(ae,H))fe<$&&0>r(pe,ae)?(N[Y]=pe,N[fe]=H,Y=fe):(N[Y]=ae,N[K]=H,Y=K);else if(fe<$&&0>r(pe,H))N[Y]=pe,N[fe]=H,Y=fe;else break e}}return F}function r(N,F){var H=N.sortIndex-F.sortIndex;return H!==0?H:N.id-F.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,f=null,d=3,p=!1,_=!1,x=!1,m=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(N){for(var F=t(u);F!==null;){if(F.callback===null)i(u);else if(F.startTime<=N)i(u),F.sortIndex=F.expirationTime,e(l,F);else break;F=t(u)}}function y(N){if(x=!1,g(N),!_)if(t(l)!==null)_=!0,W(b);else{var F=t(u);F!==null&&q(y,F.startTime-N)}}function b(N,F){_=!1,x&&(x=!1,h(I),I=-1),p=!0;var H=d;try{for(g(F),f=t(l);f!==null&&(!(f.expirationTime>F)||N&&!G());){var Y=f.callback;if(typeof Y=="function"){f.callback=null,d=f.priorityLevel;var $=Y(f.expirationTime<=F);F=n.unstable_now(),typeof $=="function"?f.callback=$:f===t(l)&&i(l),g(F)}else i(l);f=t(l)}if(f!==null)var X=!0;else{var K=t(u);K!==null&&q(y,K.startTime-F),X=!1}return X}finally{f=null,d=H,p=!1}}var R=!1,w=null,I=-1,M=5,T=-1;function G(){return!(n.unstable_now()-T<M)}function j(){if(w!==null){var N=n.unstable_now();T=N;var F=!0;try{F=w(!0,N)}finally{F?ne():(R=!1,w=null)}}else R=!1}var ne;if(typeof v=="function")ne=function(){v(j)};else if(typeof MessageChannel<"u"){var P=new MessageChannel,U=P.port2;P.port1.onmessage=j,ne=function(){U.postMessage(null)}}else ne=function(){m(j,0)};function W(N){w=N,R||(R=!0,ne())}function q(N,F){I=m(function(){N(n.unstable_now())},F)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(N){N.callback=null},n.unstable_continueExecution=function(){_||p||(_=!0,W(b))},n.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<N?Math.floor(1e3/N):5},n.unstable_getCurrentPriorityLevel=function(){return d},n.unstable_getFirstCallbackNode=function(){return t(l)},n.unstable_next=function(N){switch(d){case 1:case 2:case 3:var F=3;break;default:F=d}var H=d;d=F;try{return N()}finally{d=H}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(N,F){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var H=d;d=N;try{return F()}finally{d=H}},n.unstable_scheduleCallback=function(N,F,H){var Y=n.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?Y+H:Y):H=Y,N){case 1:var $=-1;break;case 2:$=250;break;case 5:$=1073741823;break;case 4:$=1e4;break;default:$=5e3}return $=H+$,N={id:c++,callback:F,priorityLevel:N,startTime:H,expirationTime:$,sortIndex:-1},H>Y?(N.sortIndex=H,e(u,N),t(l)===null&&N===t(u)&&(x?(h(I),I=-1):x=!0,q(y,H-Y))):(N.sortIndex=$,e(l,N),_||p||(_=!0,W(b))),N},n.unstable_shouldYield=G,n.unstable_wrapCallback=function(N){var F=d;return function(){var H=d;d=F;try{return N.apply(this,arguments)}finally{d=H}}}})(gg);mg.exports=gg;var N0=mg.exports;/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ir,depthTest:!1,depthWrite:!1})}function pm(){return new Br({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:kd(),fragmentShader:`
		...
		`,blending:ir,depthTest:!1,depthWrite:!1})}function mm(){return new Br({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:kd(),fragmentShader:`
...
`].filter(ys).join(`
`)),o=Nf(o),o=Tm(o,t),o=wm(o,t),a=Nf(a),a=Tm(a,t),a=wm(a,t),o=Am(o),a=Am(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(g=`#version 300 es
